      ...
      <div className="border-b border-slate-800/60 bg-slate-900/60 py-8 px-4 sm:px-8 lg:px-12">
        <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4 text-left">
            <div className="w-12 h-12 bg-orange-500/10 text-orange-500 rounded-2xl flex items-center justify-center shrink-0 border border-orange-500/20">
          ...
          {success ? (
            <div className="flex items-center gap-2 text-emerald-400 text-sm font-semibold bg-emerald-950/40 border border-emerald-800/50 px-4 py-2.5 rounded-xl">
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row items-center gap-2 w-full md:w-auto">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full sm:w-auto px-5 py-2.5 bg-orange-600 hover:bg-orange-700 active:bg-orange-800 text-white font-bold rounded-xl text-sm transition-all flex items-center justify-center gap-2 shrink-0 cursor-pointer disabled:opacity-50"
              >
                {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : <span>Subscribe SMS</span>}
              </button>
              {onOpenSmsModal && (
                <button
                  type="button"
          ...
          <ul className="space-y-2.5 text-sm text-slate-400">
            ...
            {onOpenSmsModal && (
              <li>
                <button
                  onClick={onOpenSmsModal}
                  className="hover:text-orange-400 transition-colors text-left cursor-pointer flex items-center gap-1 text-orange-500 font-semibold"
                >
