    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-sm animate-fade-in">
      ...
      >
        ...
        <div className="bg-[#f97316] p-6 text-white relative">
          <button
            onClick={handleClose}
            className="absolute top-4 right-4 text-white/80 hover:text-white p-1 rounded-full hover:bg-white/20 transition-colors cursor-pointer text-lg font-bold leading-none w-7 h-7 flex items-center justify-center"
            title="Close"
          >
            &times;
          </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-24 pr-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl text-sm font-medium text-slate-900 dark:text-white focus:ring-2 focus:ring-[#f97316] focus:border-transparent outline-none transition-all"
                  />
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl text-sm font-medium text-slate-900 dark:text-white focus:ring-2 focus:ring-[#f97316] focus:border-transparent outline-none transition-all"
                />
              </div>
                    ...
                    return (
                      <button
                        ...
                        className={`p-2.5 text-left rounded-xl border transition-all text-xs font-medium ${
                          active
                            ? 'border-[#f97316] bg-orange-50 dark:bg-orange-950/30 text-orange-900 dark:text-orange-200 font-bold ring-1 ring-[#f97316]'
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-3 px-4 bg-[#f97316] hover:bg-[#ea580c] active:bg-[#c2410c] text-white font-bold rounded-xl text-sm shadow-lg shadow-orange-600/30 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {isSubmitting ? (
