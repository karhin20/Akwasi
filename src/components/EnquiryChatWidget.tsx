...
export const EnquiryChatWidget: React.FC<EnquiryChatWidgetProps> = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      sender: 'bot',
      text: 'Hello! 👋 How can I assist you today with our equipment, vehicles, properties, or services like fumigation and property management?',
      time: 'Just now',
    },
  ]);
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setChatMessages((prev) => [
        ...
        {
          sender: 'bot',
          text: "I'm temporarily unavailable. Please call 0247111605 or contact us on WhatsApp: 0594594245 for immediate help.",
          time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
        },
      ]);
    } finally {
                  ...
                  >
                    ...
                    {msg.sender === 'bot' && idx > 0 && (
                      <div className="mt-2.5 pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
                        ...
                        <a
                          href={`https://wa.me/233594594245?text=${encodeURIComponent(
