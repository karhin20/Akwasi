            ...
            <div className="md:col-span-5 flex flex-col justify-between space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span>Call Seller: 0247111605</span>
                </a>
                <a
                  href={`https://wa.me/233594594245?text=Hello,%20I%20am%20interested%20in%20the%20${encodeURIComponent(listing.title)}%20listed%20on%20AkwasiJob`}
                  target="_blank"
          ...
          <div className="border-t border-slate-200 pt-6">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2.5 w-full sm:w-auto shrink-0">
                ...
                <a
                  href={`https://wa.me/233594594245?text=Hello,%20I%20am%20interested%20in%20requesting%20a%20quotation/inspection%20for%20${encodeURIComponent(listing.title)}`}
                  target="_blank"
                  rel="noopener noreferrer"
