  ...
  return (
    <div id="listing-detail-page" className="min-h-screen bg-[#f8f9fb] pb-24 text-slate-800 antialiased">
          ...
          <div className="space-y-6 lg:sticky lg:top-28">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
              ...
              <div className="mt-5 space-y-3">
                {/* WhatsApp Button */}
                <a
                  href={`https://wa.me/${(listing.seller?.whatsapp || '233247111605').replace(/\D/g, '')}?text=Hello,%20I%20am%20interested%20in%20"${encodeURIComponent(listing.title)}"%20listed%20on%20AkwasiJob%20(ID:%20${listing.id}).%20Is%20it%20still%20available?`}
                  target="_blank"
                ...
                {/* Call Button */}
                <a
                  href={`tel:${listing.seller?.phone || '0594594245'}`}
                  id="call-seller-btn"
                ...
                >
                  ...
                  <span>Call {listing.seller?.phone || '0594594245'}</span>
                </a>
              </div>
            </div>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-3 z-40 flex items-center gap-2 shadow-xl">
        <a
          href={`https://wa.me/${(listing.seller?.whatsapp || '233247111605').replace(/\D/g, '')}?text=Hello,%20I%20am%20interested%20in%20"${encodeURIComponent(listing.title)}"%20listed%20on%20AkwasiJob.`}
          target="_blank"
          rel="noopener noreferrer"
